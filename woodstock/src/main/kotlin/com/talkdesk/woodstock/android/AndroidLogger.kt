...
open class AndroidLogger(
    ...
    override fun setup() {
        log(LogLevel.TRACE, "Android Logger setup. TAG: $tag, customer logs enabled: $customerLogEnabled, internal logs enabled: $internalLogsEnabled and chunk size: $chunkSize")
    }
